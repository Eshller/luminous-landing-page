      ...
      >
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center sm:gap-5">
            <a
              href="#contact"
              className="inline-flex min-w-[220px] items-center justify-center border-2 border-(--brand) bg-(--brand) px-8 py-4 text-sm font-semibold tracking-[0.06em] text-black shadow-[0_0_32px_rgba(216,109,252,0.35)] transition-all hover:border-[#e08cff] hover:bg-[#e08cff] hover:shadow-[0_0_40px_rgba(216,109,252,0.45)]"
